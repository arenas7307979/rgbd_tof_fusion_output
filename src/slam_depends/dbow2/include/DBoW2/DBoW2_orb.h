...
#include "Orb_TemplatedDatabase.h"
#include "BowVector.h"
...
/// ORB Vocabulary
typedef DBoW2::Orb_TemplatedVocabulary<DBoW2::FORB::TDescriptor, DBoW2::FORB> OrbVocabulary;

/// FORB Database
typedef DBoW2::Orb_TemplatedDatabase<DBoW2::FORB::TDescriptor, DBoW2::FORB> OrbDatabase;
